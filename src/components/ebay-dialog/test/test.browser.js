...
describe('given the dialog is in the default state', () => {
    ...
    beforeEach(() => {
        ...
        root.addEventListener('dialog-show', showEventSpy);
    });
    ...
    function thenItIsOpen(skipRerender) {
        test('then the show event is called', () => {
            expect(showEventSpy.calledOnce).to.equal(true);
        });
...
describe('given the dialog is in the open state', () => {
    ...
    beforeEach(() => {
        ...
        closeEventSpy = sinon.spy();
        root.addEventListener('dialog-close', closeEventSpy);
    });
    ...
    function thenItIsClosed(skipRerender) {
        test('then the close event is called', () => {
            expect(closeEventSpy.calledOnce).to.equal(true);
        });
